...
var AlpacaAdvanced = function() {
    ...
    var _componentAlpacaAdvanced = function() {
        ...
        $('#alpaca-option-tree-connector').alpaca({
            schemaSource: '/otherfiles/Light/global_assets/demo_data/alpaca/optiontree-custom-schema.json',
            optionsSource: '/otherfiles/Light/global_assets/demo_data/alpaca/optiontree-custom-options.json',
            options: {
                focus: false
            }
        });
